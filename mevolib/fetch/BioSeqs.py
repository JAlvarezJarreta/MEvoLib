...
class BioSeqs:
    ...
    def from_bioseqs (cls, bioseqs_file: str):
        """Create a BioSeqs object retrieving all the information from previously saved BioSeqs sequence and 
        report files. If 'bioseqs_file' contains a relative path, the current working directory will be used
    ...
    @classmethod
    def from_seqfile (cls, seqfile: str, fileformat: str):
    ...
    def write (self, bioseqs_file: str):
